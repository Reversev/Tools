...
from resize_json import resize_json
...
dir = '/home/ir/Desktop/resize_json_img'
m_path = dir + '/mother_picture.jpg'
s_paths = dir + '/imgs/*.jpg'
for s_path in glob.glob(s_paths):
    print(s_path)
    save_imgs = dir + '/new_png/' + s_path.split('/')[-1].split('.')[0] + '.png'
    print(save_imgs)
    Picture_Synthesis(mother_img=m_path, son_img=s_path, save_img=save_imgs)
png2jpg()
resize_json()
